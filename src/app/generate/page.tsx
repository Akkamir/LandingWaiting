...
import { PlatformSizePresets, type SizePreset } from "@/components/ui/PlatformSizePresets";
    ...
    <section className="min-h-screen section-gradient">
      <div className="container py-6 md:py-8 grid gap-8 lg:grid-cols-2 items-start">
          ...
          <form className="mt-6 space-y-6" onSubmit={handleSubmit} aria-label="Formulaire de génération">
            ...
            <PlatformSizePresets 
              onSizeSelect={(size) => {
                ...
                // Ici on pourrait ajuster les paramètres de génération selon le format
              }}
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <label htmlFor="prompt" className="text-sm text-white/80 font-medium">Ou décrivez votre transformation</label>
        ...
        <div className="flex flex-col">
          ...
          <div className="card overflow-hidden rounded-2xl w-full h-80 md:h-96 lg:h-[500px] flex items-center justify-center preview-panel relative">
